...
public class MainFrame extends JFrame {
	...
	public MainFrame(LoginManager loginManager, RegisterManager registerManager, JsonExerciseDatabase libraryDB,
			JsonUserDatabase userDB, WorkoutLogController workoutCtrl, WorkoutHandling workoutHandling,
			ExerciseLibrary library, NutritionLogController nutritionCtrl, StatisticsPresenter statPresenter,
	...
	public void showUserDashboard(User user) {
		...
		DashboardUI userDashboard = new DashboardUI(this, user, workoutCtrl, workoutHandling, library, nutritionCtrl,
				statPresenter, suggestionService);
